...
int write_data(int n)
{
    ...
    dataset_u =
        H5Dcreate1(file_id1, "/data_u", complex_id, fid1, H5P_DEFAULT);
    dataset_v =
        H5Dcreate1(file_id1, "/data_v", complex_id, fid1, H5P_DEFAULT);
    dataset_w =
        H5Dcreate1(file_id1, "/data_w", complex_id, fid1, H5P_DEFAULT);
    dataset_iu =
        H5Dcreate1(file_id1, "/data_iu", complex_id, fid1, H5P_DEFAULT);
    dataset_iv =
        H5Dcreate1(file_id1, "/data_iv", complex_id, fid1, H5P_DEFAULT);
    dataset_iw =
        H5Dcreate1(file_id1, "/data_iw", complex_id, fid1, H5P_DEFAULT);

    /* write data to corresponding datasets */
    ret =
        H5Dwrite(dataset_u, complex_id, H5S_ALL, fid1, H5P_DEFAULT,
                 Matrix1);
    ret =
        H5Dwrite(dataset_v, complex_id, H5S_ALL, fid1, H5P_DEFAULT,
                 Matrix2);
    ret =
        H5Dwrite(dataset_w, complex_id, H5S_ALL, fid1, H5P_DEFAULT,
                 Matrix3);
    ret =
        H5Dwrite(dataset_iu, complex_id, H5S_ALL, fid1, H5P_DEFAULT,
                 IMatrix1);
    ret =
        H5Dwrite(dataset_iv, complex_id, H5S_ALL, fid1, H5P_DEFAULT,
                 IMatrix2);
    ret =
        H5Dwrite(dataset_iw, complex_id, H5S_ALL, fid1, H5P_DEFAULT,
                 IMatrix3);
